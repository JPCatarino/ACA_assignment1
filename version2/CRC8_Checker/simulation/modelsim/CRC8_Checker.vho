...
-- Design Ports Information
-- dOut[0]	=>  Location: PIN_K8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \cUnit|nord|y~1_combout\ : std_logic;
...
-- Equation(s):
-- \cUnit|nad2|y~0_combout\ = (\bc|s_cOut\(4) & (!\bc|s_cOut\(0) & (!\bc|s_cOut\(2) & \bc|s_cOut\(1))))
...
-- Equation(s):
-- \cUnit|nad2|y~1_combout\ = (\clk~input_o\ & (((\bc|s_cOut\(3) & \cUnit|nad2|y~0_combout\)) # (!\nGRst~input_o\)))
...
-- Equation(s):
-- \LFSR|comb~0_combout\ = \LFSR|dff7|q~q\ $ (\LFSR|dff0|q~q\ $ (\FF0|Q~q\))
...
-- Equation(s):
-- \LFSR|comb~1_combout\ = \LFSR|dff6|q~q\ $ (\LFSR|dff0|q~q\ $ (\FF0|Q~q\))
...
-- Equation(s):
-- \LFSR|comb~2_combout\ = \LFSR|dff5|q~q\ $ (\LFSR|dff0|q~q\ $ (\FF0|Q~q\))
...
-- Equation(s):
-- \LFSR|comb~3_combout\ = \LFSR|dff0|q~q\ $ (\LFSR|dff3|q~q\ $ (\FF0|Q~q\))
...
-- Equation(s):
-- \LFSR|chainXor~combout\ = \LFSR|dff0|q~q\ $ (\FF0|Q~q\)
...
\cUnit|nord|y~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \cUnit|nord|y~1_combout\ = (\clk~input_o\) # ((\bc|s_cOut\(2)) # ((\bc|s_cOut\(1)) # (!\bc|s_cOut\(0))))
...
PORT MAP (
	...
	datac => \bc|s_cOut\(0),
	datad => \bc|s_cOut\(1),
	combout => \cUnit|nord|y~1_combout\);

-- Location: LCCOMB_X16_Y1_N18
\cUnit|nord|y~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \cUnit|nord|y~0_combout\ = LCELL((\bc|s_cOut\(4) & (!\cUnit|nord|y~1_combout\ & \bc|s_cOut\(3))))
...
-- Equation(s):
-- \comb~0_combout\ = (\LFSR|dff6|q~q\) # ((\LFSR|dff7|q~q\) # ((\LFSR|dff4|q~q\) # (\LFSR|dff5|q~q\)))
...
-- Equation(s):
-- \comb~1_combout\ = (\LFSR|dff2|q~q\) # ((\LFSR|dff3|q~q\) # ((\LFSR|dff1|q~q\) # (\LFSR|dff0|q~q\)))
...
-- Equation(s):
-- \cUnit|nad4|y~1_combout\ = (\clk~input_o\ & (((\bc|s_cOut\(0) & \cUnit|nad4|y~0_combout\)) # (!\nGRst~input_o\)))
